...
class ImProcess(object):
    ...
    def __init__(self, file1, file2, matchPoints=50):
    ...
    def initiateimage(self, image):
        if image is None:
            ...
            imgres = cv2.resize(image, None, fx=.5, fy=.5, interpolation=cv2.INTER_AREA)
...
class Main(object):
    ...
    while (True):
        ...
        file2 = Camera2.getFrame()  # cv2.imread('/home/jonathan/Documents/ImageProcessingImages/img2.JPG')
        Thread1 = ImProcess(file1, file2, 50)
        Thread1.main()
